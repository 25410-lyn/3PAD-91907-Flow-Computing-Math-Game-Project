# Name: Fuzail Fazal
# Date: 27 July 2026
# Changes made: Added Settings screen, allowing adjustment of bg music volume.
...
def menu_screen():
    ...
    options = [("Leaderboard", "Compare XP rankings", BLUE, leaderboard),("Settings", "Adjust quiz-only music", ORANGE, settings),("Quit", "Close Kalc safely", RED, close_game)]
